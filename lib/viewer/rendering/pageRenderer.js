                ...
                {!isTextFrame && !isContentFrame && !element.linkedImage && (
                  <div
                    style={{
                      ...
                      backgroundColor:
                        element.name === "Bulleted List"
                          ? "rgba(255, 182, 193, 0.3)" // Light pink for bulleted lists
                          : element.name === "Numbered List"
                          ? "rgba(173, 216, 230, 0.3)" // Light blue for numbered lists
                          : "rgba(128, 128, 128, 0.2)", // Default gray
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      fontSize: "8px",
                      ...
                      border:
                        element.name === "Bulleted List"
                          ? "1px solid #d63384" // Pink border
                          : element.name === "Numbered List"
                          ? "1px solid #0d6efd" // Blue border
                          : "1px solid #999", // Default gray
                      borderRadius: "4px",
                    }}
                  >
                    {element.name === "Bulleted List"
