...
class DataModularizer {
  ...
  modularize(processedData) {
    ...
    // 18. Extracted Images (if they exist)
    if (processedData.extractedImages) {
      modules.extractedImages = this.saveModule(
        "extractedImages.json",
        processedData.extractedImages
      );
      index.modules.extractedImages = modules.extractedImages;
    }
